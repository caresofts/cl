 ...
 *
 * Full support: KaiOS 2.5 Nokias (Nokia 8110 4G, Nokia 2720 Flip, Nokia 800 Tough,Jiophone)
 ...
 * "kaiosextension" - support KaiOS 2.0 devices with unprotected extension;
...
;(function(global, nav) {
  ...
  /**
  * Enable/disable call recording in the main callscreen (KaiOS 2.5. only)
  ...
  function enableCallRecording(flag='on', format='wav', successCb, errorCb) {
    setSystemSetting('callrecording.mode', flag, function() {
      setSystemSetting('callrecording.file.format', format, function() {
        setSystemSetting('callrecording.notification.enabled', true, function() {
          setSystemSetting('callrecording.vibration.enabled', true, successCb, errorCb)
        }, errorCb)
      }, errorCb)
    }, errorCb)
  }
